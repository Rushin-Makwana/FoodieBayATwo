...
const url = "https://foodiebay-backend.herokuapp.com/menuItem";
const purl = "https://foodiebay-backend.herokuapp.com/placeOrder";
                ...
                <div className="container">
                    <div className="panel panel-primary">
                        ...
                        <div className="panel-body">
                            <form action="https://airbnb-paynow.herokuapp.com/paynow" method="POST">
                                <input type="hidden" name="price" value={this.state.cost}/>
                                ...
                                <div className="form-group col-md-6">
                                    ...
                                    <input id="address" name="location_name" className="form-control"
